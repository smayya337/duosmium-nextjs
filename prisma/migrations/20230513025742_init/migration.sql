/*
  ...
  - Added the required column `updatedAt` to the `Histogram` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updatedAt` to the `Placing` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Histogram" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
...
-- AlterTable
ALTER TABLE "Placing" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
